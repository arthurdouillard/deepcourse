...
this.hasGraded[this.noteIndex]=true;this.getElt("after-button").style.visibility="visible";}
...
displayCard(){this.getElt("after-button").style.visibility="hidden";let card=this.getElt("card");let realIndex=this.mapFakeIndexToRealIndex[this.noteIndex];this.getElt("card-front").innerHTML=this.cards[realIndex].Front;this.getElt("card-back").innerHTML=this.cards[realIndex].Back;if(this.noteIndex>0){this.getElt("previous-button").style.visibility="visible";}else{this.getElt("previous-button").style.visibility="hidden";}
if(this.hasGraded[this.noteIndex]){this.getElt("card-global-back").style.visibility="visible";if(this.noteIndex<this.cards.length-1){this.getElt("after-button").style.visibility="visible";}else{this.getElt("after-button").style.visibility="hidden";}
...
changePrevious(e){if(this.noteIndex>0){this.noteIndex=this.noteIndex-1;this.displayCard();}}
...
else if(e.keyCode=='87'&&this.getElt("card-global-back").style.visibility=="visible"){this.gradCard(true);}}};function launchQuiz(quizTitle,cards,randomOrder,instanceId,fullPage){let quiz=new Quiz(cards,quizTitle,fullPage,instanceId,randomOrder);quiz.launch();quiz.getElt("previous-button").addEventListener('click',function(){quiz.changePrevious()});quiz.getElt("after-button").addEventListener('click',function(){quiz.changeAfter()});quiz.getElt("ankiapp").addEventListener('click',function(){quiz.showBackCard()});};