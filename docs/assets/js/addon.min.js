...
this.getElt("previous-button").addEventListener('click',()=>this.changePrevious());this.getElt("after-button").addEventListener('click',()=>this.changeAfter());this.getElt("ankiapp").addEventListener('click',()=>this.showBackCard());}
getElt(eltId){let elt=document.getElementById(eltId+"-"+this.instanceId);if(elt==null){throw "Id not found: "+eltId+"-"+this.instanceId;}
return elt;}
launch(){if(this.fullPage){document.onkeydown=function(e){this.changeCard(e)};}
this.displayCard();}
...
changeAfter(){if(this.noteIndex<this.cards.length-1&&this.hasGraded[this.noteIndex]){if(!this.fullPage){this.hasGraded[this.noteIndex]=true;}
this.noteIndex=this.noteIndex+1;this.displayCard();}}
changeCard(e){e=e||window.event;if(e.keyCode=='38'||e.keyCode=='40'){this.showBackCard()}
else if(e.keyCode=='37'){this.changePrevious();}
else if(e.keyCode=='39'){this.changeAfter();}
